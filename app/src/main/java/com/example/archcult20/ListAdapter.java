...
public class ListAdapter extends ArrayAdapter<ExcelSample> {

    private List<ExcelSample> schedules;

    public ListAdapter(@NonNull Context context, int resource, @NonNull List<ExcelSample> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        ExcelSample schedule = schedules.get(position);
